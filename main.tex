...
by appending the domain name of the proxy, making the target domain a subdomain of the proxy domain, e.g., \emph{http://google.com.proxy.domain/search?q=proxy}. 
