...
have investigated a number of password strength services. The services can be
...
One way to enforce that the password does not leave the browser is to
isolate the service, i.e., prevent it from performing any communication at all.
While effective, such a stern policy risk breaking the functionality of the service.
Even though the password does not need to be communicated back to the service provider
