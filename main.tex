...
Certain headers, e.g. the \emph{Host} and \emph{Location} header, includes the modified domain name. These need to be replaced 
...
Currently rudimentary communication
